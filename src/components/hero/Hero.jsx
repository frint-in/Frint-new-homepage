...
const Hero = () => {
  return (
    <div className="heroSection">
      <section className="hero" onMouseMove={parallax}>
        <img
        ...
        {/* <img
          ...
          className="layer"
        /> */}
        <p className="title layer" data-speed={0}>
            Made by Students for Students
        </p>
        <h2 className="layer" data-speed={0}>
          say {" "}
          ...
          to your new Internship
        </h2>
        <p className="subtitle layer" data-speed={0}>
        Frint is a community-driven service that helps find you a dream internship, job and great opportunities
        </p>
      </section>
    </div>
    ...
    //       <div className="left">
    //         <div className="tagline">Made by Students, for Students</div>
    //         <h1>
    //           Say <span className="blue">Hi</span> to your new Internship!
    //         </h1>
    //         <p>
    //           Frint is a community-driven service that helps find you a dream
    //           internship, job and great opportunities.
    //         </p>
    //       </div>
    //     </div>
    //   </section>
